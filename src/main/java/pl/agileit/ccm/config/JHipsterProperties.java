...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ccm@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ccm API";

        private String description = "ccm API documentation";
